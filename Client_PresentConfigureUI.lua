function Client_PresentConfigureUI(rootParent)
	...
	UI.CreateLabel(vert).SetText("This mod makes commanders do three things: 1.- Commanders will spawn armies at the begining of each round. 2.-Whenever a commander is part of a defending or atacking army, a percentage of casualties will be replenished. 3.-Whenever a commander is part of a defending or atacking army, a percentage of the surviving enemy armies will flee (die for practical purposes). Note: This effect only applies to armies that were actually involved in the fight and not to all armies in the atacking territory. Note 2: The replenishment and flee effects happen after the fight is resolved, if the commander does not survive the fight the player looses the game.").SetColor(textColor)
